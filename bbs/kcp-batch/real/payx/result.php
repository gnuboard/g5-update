...
?>
                    ...
                    <table class="tbl" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <th>주문자 전화번호</th>
                          <td><?php echo $buyr_tel1 ?></td>
                        </tr>
                        <!-- 주문자 휴대폰번호 -->
                        <tr>
                          <th>주문자 휴대폰번호</th>
                          <td><?php echo $buyr_tel2 ?></td>
                        </tr>
                        <!-- 주문자 E-mail -->
                        <tr>
                          <th>주문자 E-mail</th>
                          <td><?php echo $buyr_mail ?></td>
                        </tr>
                    </table>
<?php
                /* ============================================================================== */
...
?>
                    ...
                    <table class="tbl" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <th>결제 카드</th>
                          <td><?php echo $card_cd ?> / <?php echo $card_name ?></td>
                        </tr>
                        <!-- 승인시간 -->
                        <tr>
                          <th>승인 시간</th>
...
?>
                        <tr>
                          <th>영수증 확인</th>
                            <td class="sub_content1"><a href="javascript:receiptView('<?php echo $tno?>')"><img src="./img/btn_receipt.gif" alt="영수증을 확인합니다." />
                        </td>
                    </table>
<?php
                }
...
?>
             ...
             <table class="tbl" cellpadding="0" cellspacing="0">
                 ...
                 <!-- 부분취소 요청금액 -->
                     <tr>
                       <th>부분취소 요청금액</th>
                       <td><?php echo $panc_mod_mny ?></td>
                      </tr>
                 <!-- 부분취소 가능금액 -->
                      <tr>
                        <th>부분취소 가능금액</th>
                        <td><?php echo $panc_rem_mny ?></td>
                      </tr>
             </table>
<?php
                    }
