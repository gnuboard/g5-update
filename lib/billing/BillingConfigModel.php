...
class BillingConfigModel
{
    ...
    public function insert($resultData = array())
    {
        ...
        $bindParam = array(
            ...
            'bc_kcp_cert'           => $resultData['bc_kcp_cert'],
            ...
            'bc_toss_client_key'    => $resultData['bc_toss_client_key'],
            'bc_toss_secret_key'    => $resultData['bc_toss_secret_key'],
            'bc_toss_customer_key'  => $resultData['bc_toss_customer_key'],
