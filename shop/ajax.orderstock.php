...
if (is_select_time_over($tmp_cart_id)) {
    die("주문 요청 때까지 " . get_select_limit_time("minute") . "분 이상 경과되어 주문 상품이 초기화 됐습니다.\n\n 장바구니에서 주문하실 상품을 다시 확인해 주십시오.");
}
...
for($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    $check_stockout = check_stockout_item($row, $tmp_cart_id, false);
