...
<div class="item_box remove_border">
    <ul>
        ...
        <li class="price_area">
            <div class="price"><?php echo $service_info['display_recurring1'] ?> <?php echo  number_format($service_info['price']) ?>원 (부가세 포함)</div>
            <div><?php echo $service_info['recurring'] ?><?php echo $service_info['display_recurring2'] ?> 마다 정기 결제</div>
        </li>
