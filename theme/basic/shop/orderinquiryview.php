	                ...
	                <span>
	                    ...
	                    if($od['od_settle_case'] == '휴대폰')
	                    {
	                        if($od['od_pg'] == 'lg') {
                                ...
                                $hp_receipt_script = 'window.open(\'' . G5_SHOP_URL. '/toss/receipt_view.php?od_tno=' . $od['od_tno'] . '\',\'receipt\',\'width=900,height=700\');';
	                    ...
	                    if($od['od_settle_case'] == '신용카드' || is_inicis_order_pay($od['od_settle_case']) || (shop_is_taxsave($od, true) && $misu_price == 0) )
	                    {
	                        if($od['od_pg'] == 'lg') {
                                ...
                                $card_receipt_script = 'window.open(\'' . G5_SHOP_URL. '/toss/receipt_view.php?od_tno=' . $od['od_tno'] . '\',\'receipt\',\'width=900,height=700\');';
	                        } else if($od['od_pg'] == 'inicis') {
	            ...
	            <li>
	                ...
	                if ($od['od_cash'])
	                {
	                    if($od['od_pg'] == 'lg') {
	                        ...
	                        $cash = json_decode($od['od_cash_info']);
                            $cash_receipt_script = 'window.open(\'' . $cash->receiptUrl . '\', \'showreceipt\', \'width=380,height=540,scrollbars=no,resizable=no\');';
	                    } else if($od['od_pg'] == 'inicis') {
